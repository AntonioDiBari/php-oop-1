...
$gameOfThrones = new TvSerie("Game of Thrones", "ENG", 8.9, [new Genre("Fantasy", "Vicende di una storia Medioevale con draghi e lotte di potere."), new Genre("Historical", "Descrizione")], 8, 73);
...
$pulpFiction = new Movie("Pulp Fiction", "ENG", 7.8, [new Genre("Thriller", "Storia di 2 agenti speciali"), new Genre("Action", "Descrizione")], 4743305, 144);

// var_dump($lost, $pulpFiction);
